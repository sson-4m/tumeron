    ...
    @IBAction func startButton(_ sender: UIButton){
        if trueNumbersArray.count == 0{
            ...
            if heartCounter == 3{
                ...
                answerNum = Int.random(in: 0..<answers3.count-1)
            ...
            if heartCounter >= 1{
                if heartCounter == 2{
                    if self.levelCounter == 3{
                        ...
                        hints3[answerNum].append("\(inputNum.map{ String($0) }.joined(separator: ""))" + "=" + String(h) + "H" + String(b) + "B")
                        resultsUpdatedInTableView = hints3[answerNum]
                    }
                    imageDependsOnHeart.image = image3
                    ...
                    if self.levelCounter == 3{
                        hints3[answerNum].append("\(inputNum.map{ String($0) }.joined(separator: ""))" + "=" + String(h) + "H" + String(b) + "B")
                        resultsUpdatedInTableView = hints3[answerNum]
                    }else if self.levelCounter == 2{
                        hints2[answerNum].append("\(inputNum.map{ String($0) }.joined(separator: ""))" + "=" + String(h) + "H" + String(b) + "B")
                        resultsUpdatedInTableView = hints2[answerNum]
                    }
